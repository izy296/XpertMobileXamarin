...
{
    public class XpertWebException : Exception
    {
        ...
        public static string MODULE_XPERTPHARM = "XpertPHarm";
        ...
        public XpertWebException(string module, int code, string message, Exception e, object[] args)
            : base(message, e)
        {
            Module = module;
            Code = code;
        ...
        public XpertWebException(Exception e)
            : this(MODULE_XPERTCOM, ERROR_XPERT_UNKNOWN, "", e, null)
        {

        }

        public XpertWebException(string message)
            : this(MODULE_XPERTCOM, ERROR_XPERT_UNKNOWN, message, null, null)
        {

        }

        public XpertWebException(string message, Exception e)
            : this(MODULE_XPERTCOM, ERROR_XPERT_UNKNOWN, message, e, null)
        {

        }

        public XpertWebException(string message, int code)
