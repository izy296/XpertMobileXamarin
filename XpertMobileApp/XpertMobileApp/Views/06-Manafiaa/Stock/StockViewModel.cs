...
namespace XpertMobileApp.ViewModels
{
    ...
    public class StockViewModel : CrudBaseViewModel2<STK_STOCK, View_STK_STOCK>
    {
        ...
        protected override QueryInfos GetFilterParams()
        {
            ...
            if (!string.IsNullOrEmpty(SelectedFamille?.CODE))
                this.AddCondition<View_STK_STOCK, string>(e => e.CODE_FAMILLE, SelectedFamille?.CODE);

            if (!string.IsNullOrEmpty(SelectedType?.CODE_TYPE))
                this.AddCondition<View_STK_STOCK, string>(e => e.TYPE_PRODUIT, SelectedType?.CODE_TYPE);
